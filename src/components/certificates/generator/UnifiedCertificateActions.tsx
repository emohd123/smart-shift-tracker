...
type UnifiedCertificateActionsProps = {
...
export default function UnifiedCertificateActions({
  certificateData,
  certificateType,
  downloading,
  sharing,
  ...
  handleShare,
  handleEmail
}: UnifiedCertificateActionsProps) {
  ...
  const certificateTypeLabel = certificateType === "skills" ? "Skills Certificate" : "Work Experience Certificate";
