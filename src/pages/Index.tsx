        ...
        <div className="container px-4 relative z-10">
          ...
          >
            <div className="flex justify-center gap-4 mb-4">
              <a href="https://instagram.com/formbuilder.onestone" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:text-pink-700 transition-colors" aria-label="Instagram">
              ...
              <a href="https://facebook.com/onestoneads" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 transition-colors" aria-label="Facebook">
